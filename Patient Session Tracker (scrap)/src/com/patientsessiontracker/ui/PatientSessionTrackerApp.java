...
public class PatientSessionTrackerApp extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					// Get users
					List<User> users = patientDAO.getUsers();
	 ...
	 * Create the frame.
	 */
	public PatientSessionTrackerApp(int theUserId, PatientDAO thePatientDAO) {
		...
		btnAddEmployee.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// create dialog
				PatientDialog dialog = new PatientDialog(PatientSessionTrackerApp.this, patientDAO, userId);
		...
		btnUpdateEmployee.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (row < 0) {
					JOptionPane.showMessageDialog(PatientSessionTrackerApp.this, "You must select a patient", "Error",
				...
				// create dialog
				PatientDialog dialog = new PatientDialog(PatientSessionTrackerApp.this, patientDAO, 
		...
		viewHistoryButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					exc.printStackTrace();
					JOptionPane.showMessageDialog(PatientSessionTrackerApp.this, "Error retrieving audit history", "Error",
							JOptionPane.ERROR_MESSAGE);				
					return;					
				}
