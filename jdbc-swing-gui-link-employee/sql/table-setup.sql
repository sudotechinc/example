...
INSERT INTO `users` (`id`,`last_name`,`first_name`,`email`) VALUES (1,'Alpha','Joe','joe.alpha@foo.com');
INSERT INTO `users` (`id`,`last_name`,`first_name`,`email`) VALUES (2,'Beta','Jane','jane.beta@foo.com');
INSERT INTO `users` (`id`,`last_name`,`first_name`,`email`) VALUES (3,'Zeta','Becky','becky.zeta@foo.com');